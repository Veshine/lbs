...
public class Ptktimur extends FragmentActivity implements LocationListener, OnMapReadyCallback {
...
//Lihat Lokasi Berdasarkan:
        ...
        gps = new GpsService(Ptktimur.this);
        if (gps.GetLocation())
        {
    ...
    public class AmbilData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Ptktimur.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String url;
            url = "http://lbsgereja.esy.es/android/grjnear-ptktimur.php";
        ...
        protected void onPostExecute(String result) {
            ...
            GMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
                    ...
                    Intent intent = new Intent(Ptktimur.this, Halamaninformasigereja.class);

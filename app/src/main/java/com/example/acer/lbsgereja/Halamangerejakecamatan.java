...
public class Halamangerejakecamatan extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        kode = bundle.getString("idk");
        nama = bundle.getString("namak");
        ...
        gps = new GpsService(Halamangerejakecamatan.this);
        if (gps.GetLocation())
        {
    ...
    public class AmbilData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            pDialog = new ProgressDialog(Halamangerejakecamatan.this);
        ...
        protected String doInBackground(String... args)
        {
            ...
            String url;
            url = "http://lbsgereja.esy.es/android/daftargrjkec2.php"; //bisa

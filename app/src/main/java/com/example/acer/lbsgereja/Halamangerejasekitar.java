...
import com.example.acer.lbsgereja.filter.Katolik;
import com.example.acer.lbsgereja.filter.Kristen;
import com.example.acer.lbsgereja.filter.Ptkbarat;
import com.example.acer.lbsgereja.filter.Ptkkota;
import com.example.acer.lbsgereja.filter.Ptkselatan;
import com.example.acer.lbsgereja.filter.Ptktenggara;
import com.example.acer.lbsgereja.filter.Ptktimur;
import com.example.acer.lbsgereja.filter.Ptkutara;
...
public class Halamangerejasekitar extends FragmentActivity implements LocationListener, OnMapReadyCallback {
...
//Lihat Lokasi Berdasarkan:
        ...
        gps = new GpsService(Halamangerejasekitar.this);
        if (gps.GetLocation())
        {
    ...
    public void CekGPS() {
        ...
        if (status != ConnectionResult.SUCCESS) {
            ...
            GMap.animateCamera(CameraUpdateFactory.newLatLngZoom(lokasi, 14));
    ...
    public class AmbilData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Halamangerejasekitar.this);
        ...
        protected String doInBackground(String... args) {
            ...
            //param.add(new BasicNameValuePair("id_kecamatan", kode));
            //

            String url;
            //url = "http://lbsgereja.esy.es/android/grjnear2.php?lat="+currentlat+"&lng="+currentlng;
            url = "http://lbsgereja.esy.es/android/grjnear2.php";
        ...
        protected void onPostExecute(String result) {
            ...
            for (int x = 0; x < dataList1.size(); x = x + 1) {
                ...
                String almg = dataList1.get(x).get("alamat");
            ...
            GMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
                    ...
                    Intent intent = new Intent(Halamangerejasekitar.this, Halamaninformasigereja.class);

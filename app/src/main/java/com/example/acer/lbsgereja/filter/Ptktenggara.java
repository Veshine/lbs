...
public class Ptktenggara extends FragmentActivity implements LocationListener, OnMapReadyCallback {
...
//Lihat Lokasi Berdasarkan:
        ...
        gps = new GpsService(Ptktenggara.this);
        if (gps.GetLocation())
        {
    ...
    public class AmbilData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Ptktenggara.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String url;
            url = "http://lbsgereja.esy.es/android/grjnear-ptktenggara.php";
        ...
        protected void onPostExecute(String result) {
            ...
            GMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
                    ...
                    Intent intent = new Intent(Ptktenggara.this, Halamaninformasigereja.class);

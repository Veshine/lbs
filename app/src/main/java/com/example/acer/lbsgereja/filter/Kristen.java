...
/**
 * Created by document on 27/08/2018.
 */

public class Kristen extends FragmentActivity implements LocationListener, OnMapReadyCallback {
...
//Lihat Lokasi Berdasarkan:
        ...
        gps = new GpsService(Kristen.this);
        if (gps.GetLocation())
        {
    ...
    public class AmbilData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Kristen.this);
        ...
        protected String doInBackground(String... args) {
            ...
            String url;
            url = "http://lbsgereja.esy.es/android/grjnear-kristen.php";
        ...
        protected void onPostExecute(String result) {
            ...
            GMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
                    ...
                    Intent intent = new Intent(Kristen.this, Halamaninformasigereja.class);
